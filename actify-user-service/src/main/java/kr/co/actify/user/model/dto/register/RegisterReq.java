package kr.co.actify.user.model.dto.register;

import kr.co.actify.user.model.vo.UsersInformationGender;
import kr.co.actify.user.util.validator.PasswordMatch;
import kr.co.actify.user.util.validator.ValiDate;
...
public class RegisterReq {
    ...
    /** 선택사항: 마케팅 수신 동의 일시 */
    private LocalDateTime agreeeMarketingAt;
